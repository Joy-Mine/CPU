...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.runs/cpuclk_synth_1 -new_name cpuclk -ip [get_ips cpuclk]]
...
if { [catch {
  file copy -force C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.runs/cpuclk_synth_1/cpuclk.dcp C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.runs/cpuclk_synth_1/cpuclk_stub.v C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.runs/cpuclk_synth_1/cpuclk_stub.vhdl C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.runs/cpuclk_synth_1/cpuclk_sim_netlist.v C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.runs/cpuclk_synth_1/cpuclk_sim_netlist.vhdl C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.ip_user_files/ip/cpuclk]} {
  catch { 
    file copy -force C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_stub.v C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.ip_user_files/ip/cpuclk
  }
}

if {[file isdir C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.ip_user_files/ip/cpuclk]} {
  catch { 
    file copy -force C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.srcs/sources_1/ip/cpuclk_2/cpuclk_stub.vhdl C:/Users/gmcc/Desktop/cpu1/CPU_1/CPU_1.ip_user_files/ip/cpuclk
  }
}
