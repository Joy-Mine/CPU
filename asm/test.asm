...
sw $0,0xC64($28)
   ...
   add $27,$25,$0   #显示
    ...
    loop_q01112:
    addi $27,$27,-1
    bne $27,$0,loop_q01112

    sw $10, 0xC80($28)
    addi $10,$10,-1
    bne $10,$0,loop_q2_test
    j loop
...
q3:
   ...
   loop_q3_test:
    ...
    loop_q01113:
    addi $27,$27,-1
    bne $27,$0,loop_q01113

    bne $11,$10,loop_q3_test
